...
namespace InternshipAssignment.Controllers
{
    public class MaritalStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaritalStatusId,MaritalStatusName,EntryDate")] MaritalStatus maritalStatus)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var maritalStatus = await _context.MaritalStatus.SingleOrDefaultAsync(m => m.MaritalStatusId == id);
            if (maritalStatus == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaritalStatusId,MaritalStatusName,EntryDate")] MaritalStatus maritalStatus)
        {
