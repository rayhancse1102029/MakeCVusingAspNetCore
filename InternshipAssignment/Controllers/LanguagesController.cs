...
namespace InternshipAssignment.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LanguageId,LanguageName,EntryDate")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LanguageId,LanguageName,EntryDate")] Language language)
        {
